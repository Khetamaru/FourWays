...
{
    internal class BlueCar : Car
    {
        internal static new DeathColor Color;
        internal static int Ponderation = 3;
        public BlueCar(Direction direction, uint WindowWidth, uint WindowHeight, RoadLight roadLight, Func<Car, List<Car>> collideTest, Dictionary<Direction, Texture> texture, Font arial, DeathColor Color)
