...
namespace FourWays.Game.Objects.CarChildren
{
    internal class WhiteCar : Car
    {
        ...
        public WhiteCar(Direction direction, uint WindowWidth, uint WindowHeight, RoadLight roadLight, Func<Car, List<Car>> collideTest, Dictionary<Direction, Texture> texture, Font arial, CarColor Color)
