...
namespace FourWays.Game.Objects.CarChildren
{
    internal class YellowCar : Car
    {
        ...
        public YellowCar(Direction direction, uint WindowWidth, uint WindowHeight, RoadLight roadLight, Func<Car, List<Car>> collideTest, Dictionary<Direction, Texture> texture, Font arial, CarColor Color)
