...
namespace FourWays.Game.Objects.Graphs
{
    public class SucessGraph
    {
        ...
        public SucessGraph(GameLoop parent, Vector2f position, Color fontColor)
        {
        ...
        {
            Text text1 = new Text("Sucess : " + ResultTab[0], ConsoleFont, 14);
            text1.Position = new Vector2f(Position.X, Position.Y);
            text1.FillColor = FontColor;
            Parent.Window.Draw(text1);

            Text text2 = new Text("Fail : " + ResultTab[1], ConsoleFont, 14);
